...
- (id)init
{
    if (self = [super init])
    {
        ...
        // Create spacing
        UIBarButtonItem *flex = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemSave target:self action:@selector(buttonSavePressed:)];
        flex.tintColor = UIColorFromRGB(0xC84131);
