...
{
    GlossaryViewController *GlossaryView = [[GlossaryViewController alloc] initWithNibName:@"GlossaryViewController" bundle:nil];
    GlossaryView.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
    [self presentModalViewController:GlossaryView animated:YES];
//    GurgleItemsViewController *GlossaryView = [[GurgleItemsViewController alloc] initWithNibName:@"GurgleItemsViewController" bundle:nil];
//    GlossaryView.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
//    [self presentModalViewController:GlossaryView animated:YES];
}
...
- (IBAction)showFAQView:(id)sender
{
    ...
    FAQView.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
    [self presentModalViewController:FAQView animated:YES];
}
