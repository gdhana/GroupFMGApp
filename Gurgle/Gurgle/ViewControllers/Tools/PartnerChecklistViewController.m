//
//  PartnerChecklistViewController.m
//  Gurgle
//
...
#import "PartnerChecklistViewController.h"

@interface PartnerChecklistViewController ()

@end

@implementation PartnerChecklistViewController
...
- (IBAction)PartnerChecklistdone:(id)sender
{
