...
@interface BirthplaninfoViewController ()

@end

@implementation BirthplaninfoViewController
...
- (IBAction)Birthplaninfoviewdone:(id)sender
{
...
{
//    BirthplaninfoViewController *Birthplaninfo = [[BirthplaninfoViewController alloc] initWithNibName:@"BirthplaninfoViewController" bundle:nil];
//    Birthplaninfo.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
//    [self presentModalViewController:Birthplaninfo animated:YES];
    [self dismissModalViewControllerAnimated:YES];
}
