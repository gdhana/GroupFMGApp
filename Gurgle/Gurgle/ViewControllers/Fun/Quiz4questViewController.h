...
@interface Quiz4questViewController : UIViewController
{
    IBOutlet UIScrollView *Quizs4crollview;
    IBOutlet UIScrollView *Q4scrollview2;
    
    IBOutlet UILabel *ResultTitlelbl;
    IBOutlet UILabel *ResultDescrlbl;
    
    IBOutlet UIImageView *bottombanner;
    IBOutlet UIImageView *Topbanner;
    
    IBOutlet UIImageView *Q4As;
