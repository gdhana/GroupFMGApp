...
#import "Quiz4infoViewController.h"
...
@interface Quiz4questViewController ()

@end

static int countQA1,countQB1,countQC1,count;

@implementation Quiz4questViewController
...
//    [bottombanner startAnimating];
    ...
    [super viewDidLoad];
    Quizs4crollview.hidden = NO;
    Q4scrollview2.hidden = YES;
    [Q4scrollview2 setScrollEnabled:YES];
    Q4As.hidden = YES;
    // Do any additional setup after loading the view from its nib.
    [Quizs4crollview setScrollEnabled:YES];
    [Quizs4crollview setContentSize:CGSizeMake(320, 1685)];
    [Quizs4crollview flashScrollIndicators];
...
- (void)QuestionResultValidation
{
    ...
    if(count == 8){
        if (countQA1 == 8 || countQA1 == 7 || countQA1 == 6 || countQA1 == 5) {
            Quizs4crollview.hidden = YES;
            Q4scrollview2.hidden = NO;
            //        CGRect rect = CGRectMake(16.0f, 52.0f, 293, 247);
            //        Q1As.frame = rect;
            [Q4scrollview2 setContentSize:CGSizeMake(320, 435)];
            ResultTitlelbl.text = [NSString stringWithFormat:@"Mostly As"];
            ResultDescrlbl.frame = CGRectMake(20, 129, 288, 253);
            ResultDescrlbl.numberOfLines = 18;
            ResultDescrlbl.text = [NSString stringWithFormat:@" You love celebrity culture and aspire to have the best of everything. Your baby would suit a celebrity baby name. Some of the best baby names chosen by celebrities in the past 12 months are:\nBoys\n1.  Flynn\n2.  Mason \n3.  Xander\n4.  Arlo\n5.  Leo"];
            Q4As.image = [UIImage imageNamed:@"Q4As.png"];  //398
            Q4As.hidden = NO;
            countQA1 = 0;
        }
            ...
            ResultDescrlbl.numberOfLines = 18;
            ResultDescrlbl.text = [NSString stringWithFormat:@" You love celebrity culture and aspire to have the best of everything. Your baby would suit a celebrity baby name. Some of the best baby names chosen by celebrities in the past 12 months are:\nBoys\n1.  Flynn\n2.  Mason \n3.  Xander\n4.  Arlo\n5.  Leo"];
            Q4As.image = [UIImage imageNamed:@"Q4As.png"];
            Q4As.hidden = NO;
            countQA1 = 0;
        }
            ...
            Quizs4crollview.hidden = YES;
            Q4scrollview2.hidden = NO;
            [Q4scrollview2 setContentSize:CGSizeMake(320, 515)];
            ResultTitlelbl.text = [NSString stringWithFormat:@"Mostly Bs"];
            ResultDescrlbl.frame = CGRectMake(20, 129, 288, 355);
            ResultDescrlbl.numberOfLines = 18;
            ResultDescrlbl.text = [NSString stringWithFormat:@" You have traditional values and like to blend in with the group. Your baby would suit a traditional baby name. The most popular baby names of the past 12 months are:\nBoys\n1. Oliver\n2. Jack\n3. Harry\n4. Charlie\n5. James \nGirls\n1. Lily\n2. Emily\n3. Isabella\n4. Sophia\n5. Olivia"];
            Q4As.image = [UIImage imageNamed:@"Q4Bs.png"]; //355
            Q4As.hidden = NO;
            countQB1 = 0;
        }
            ...
            Q4As.image = [UIImage imageNamed:@"Q4Bs.png"];
            Q4As.hidden = NO;
            countQA1 = 0;
        }
            ...
            ResultDescrlbl.frame = CGRectMake(20, 129, 288, 355);
            ResultDescrlbl.numberOfLines = 18;
            ResultDescrlbl.text = [NSString stringWithFormat:@" You’re free spirited and you don’t follow the crowd. Your baby would suit an unusual baby name. Here are some of gurgle.com’s favourite unusual baby names: \nBoys\n1.  Lennon\n2.  Ziggy \n3.  Otto\n4.  Felix \n5.  Barnaby\nGirls\n1.  Allegra\n2.  Janis\n3.  China\n4.  Echo\n5.  Meadow"];
            Q4As.image = [UIImage imageNamed:@"Q4Cs.png"];//355
            Q4As.hidden = NO;
            countQC1 = 0;
        }
            ...
            ResultDescrlbl.numberOfLines = 18;
            ResultDescrlbl.text = [NSString stringWithFormat:@" You’re free spirited and you don’t follow the crowd. Your baby would suit an unusual baby name. Here are some of gurgle.com’s favourite unusual baby names: \nBoys\n1.  Lennon\n2.  Ziggy \n3.  Otto\n4.  Felix \n5.  Barnaby\nGirls\n1.  Allegra\n2.  Janis\n3.  China\n4.  Echo\n5.  Meadow"];
            Q4As.image = [UIImage imageNamed:@"Q4Cs.png"];
            Q4As.hidden = NO;
            countQA1 = 0;
        }
            ...
            Quizs4crollview.hidden = YES;
            Q4scrollview2.hidden = NO;
//            [Q4scrollview2 setContentSize:CGSizeMake(321, 570)];
//            CGRect rect = CGRectMake(16.0f, 1.0f, 289, 529);
//            Q4As.frame = rect;
            [Q4scrollview2 setContentSize:CGSizeMake(320, 850)];
            ResultTitlelbl.text = [NSString stringWithFormat:@"Mostly As & Bs"];
            ResultDescrlbl.frame = CGRectMake(20, 129, 288, 691);
            ResultDescrlbl.numberOfLines = 33;
            ResultDescrlbl.text = [NSString stringWithFormat:@"Mostly As:\n You love celebrity culture and aspire to have the best of everything. Your baby would suit a celebrity baby name. Some of the best baby names chosen by celebrities in the past 12 months are:\nBoys\n1.  Flynn\n2.  Mason \n3.  Xander\n4.  Arlo\n5.  Leo\n\nMostly Bs:\n You have traditional values and like to blend in with the group. Your baby would suit a traditional baby name. The most popular baby names of the past 12 months are:\nBoys\n1. Oliver\n2. Jack\n3. Harry\n4. Charlie\n5. James \nGirls\n1. Lily\n2. Emily\n3. Isabella\n4. Sophia\n5. Olivia"];
            Q4As.image = [UIImage imageNamed:@"Q4As&Bs.png"]; //816 41 691 33
            Q4As.hidden = NO;
...
//            Q4As.frame = rect;
            ...
            ResultDescrlbl.numberOfLines = 33;
            ResultDescrlbl.text = [NSString stringWithFormat:@"Mostly As:\n You love celebrity culture and aspire to have the best of everything. Your baby would suit a celebrity baby name. Some of the best baby names chosen by celebrities in the past 12 months are:\nBoys\n1.  Flynn\n2.  Mason \n3.  Xander\n4.  Arlo\n5.  Leo\n\nMostly Bs:\n You have traditional values and like to blend in with the group. Your baby would suit a traditional baby name. The most popular baby names of the past 12 months are:\nBoys\n1. Oliver\n2. Jack\n3. Harry\n4. Charlie\n5. James \nGirls\n1. Lily\n2. Emily\n3. Isabella\n4. Sophia\n5. Olivia"];
            Q4As.image = [UIImage imageNamed:@"Q4As&Bs.png"];
            Q4As.hidden = NO;
            ...
            ResultDescrlbl.frame = CGRectMake(20, 129, 288, 691);
            ResultDescrlbl.numberOfLines = 33;
            ResultDescrlbl.text = [NSString stringWithFormat:@"Mostly As:\n You love celebrity culture and aspire to have the best of everything. Your baby would suit a celebrity baby name. Some of the best baby names chosen by celebrities in the past 12 months are:\nBoys\n1.  Flynn\n2.  Mason \n3.  Xander\n4.  Arlo\n5.  Leo\n\nMostly Cs:\n You’re free spirited and you don’t follow the crowd. Your baby would suit an unusual baby name. Here are some of gurgle.com’s favourite unusual baby names: \nBoys\n1.  Lennon\n2.  Ziggy \n3.  Otto\n4.  Felix \n5.  Barnaby\nGirls\n1.  Allegra\n2.  Janis\n3.  China\n4.  Echo\n5.  Meadow"];
//            [Q4scrollview2 setContentSize:CGSizeMake(321, 570)];
            Q4As.image = [UIImage imageNamed:@"Q4As&Cs.png"]; //816 41
//            CGRect rect = CGRectMake(16.0f, 1.0f, 289, 529);
//            Q4As.frame = rect;
            Q4As.hidden = NO;
            ...
            ResultDescrlbl.text = [NSString stringWithFormat:@"Mostly As:\n You love celebrity culture and aspire to have the best of everything. Your baby would suit a celebrity baby name. Some of the best baby names chosen by celebrities in the past 12 months are:\nBoys\n1.  Flynn\n2.  Mason \n3.  Xander\n4.  Arlo\n5.  Leo\n\nMostly Cs:\n You’re free spirited and you don’t follow the crowd. Your baby would suit an unusual baby name. Here are some of gurgle.com’s favourite unusual baby names: \nBoys\n1.  Lennon\n2.  Ziggy \n3.  Otto\n4.  Felix \n5.  Barnaby\nGirls\n1.  Allegra\n2.  Janis\n3.  China\n4.  Echo\n5.  Meadow"];
          //  [Q4scrollview2 setContentSize:CGSizeMake(321, 570)];
            Q4As.image = [UIImage imageNamed:@"Q4As&Cs.png"];
          //  CGRect rect = CGRectMake(16.0f, 1.0f, 289, 529);
         //   Q4As.frame = rect;
            Q4As.hidden = NO;
            countQA1 = 0;countQB1 = 0;countQC1 = 0;
            ...
            Quizs4crollview.hidden = YES;
            Q4scrollview2.hidden = NO;
            [Q4scrollview2 setContentSize:CGSizeMake(320, 970)];
            ResultTitlelbl.text = [NSString stringWithFormat:@"Mostly Bs & Cs"];
            ResultDescrlbl.frame = CGRectMake(20, 129, 288, 800);
            ResultDescrlbl.numberOfLines = 39;
            ResultDescrlbl.text = [NSString stringWithFormat:@"Mostly Bs:\n You have traditional values and like to blend in with the group. Your baby would suit a traditional baby name. The most popular baby names of the past 12 months are:\nBoys\n1. Oliver\n2. Jack\n3. Harry\n4. Charlie\n5. James \nGirls\n1. Lily\n2. Emily\n3. Isabella\n4. Sophia\n5. Olivia\n\nMostly Cs:\n You’re free spirited and you don’t follow the crowd. Your baby would suit an unusual baby name. Here are some of gurgle.com’s favourite unusual baby names: \nBoys\n1.  Lennon\n2.  Ziggy \n3.  Otto\n4.  Felix \n5.  Barnaby\nGirls\n1.  Allegra\n2.  Janis\n3.  China\n4.  Echo\n5.  Meadow"];
           // [Q4scrollview2 setContentSize:CGSizeMake(321, 570)];
            Q4As.image = [UIImage imageNamed:@"Q4Bs&Cs.png"]; //794 41
           // CGRect rect = CGRectMake(16.0f, 1.0f, 289, 529);
          //  Q4As.frame = rect;
            Q4As.hidden = NO;
            ...
            Quizs4crollview.hidden = YES;
            Q4scrollview2.hidden = NO;
            [Q4scrollview2 setContentSize:CGSizeMake(320, 940)];
            ResultTitlelbl.text = [NSString stringWithFormat:@"Mostly Bs & Cs"];
            ResultDescrlbl.frame = CGRectMake(20, 129, 288, 800);
            ResultDescrlbl.numberOfLines = 39;
            ResultDescrlbl.text = [NSString stringWithFormat:@"Mostly Bs:\n You have traditional values and like to blend in with the group. Your baby would suit a traditional baby name. The most popular baby names of the past 12 months are:\nBoys\n1. Oliver\n2. Jack\n3. Harry\n4. Charlie\n5. James \nGirls\n1. Lily\n2. Emily\n3. Isabella\n4. Sophia\n5. Olivia\n\nMostly Cs:\n You’re free spirited and you don’t follow the crowd. Your baby would suit an unusual baby name. Here are some of gurgle.com’s favourite unusual baby names: \nBoys\n1.  Lennon\n2.  Ziggy \n3.  Otto\n4.  Felix \n5.  Barnaby\nGirls\n1.  Allegra\n2.  Janis\n3.  China\n4.  Echo\n5.  Meadow"];
            // [Q4scrollview2 setContentSize:CGSizeMake(321, 570)];
            Q4As.image = [UIImage imageNamed:@"Q4Bs&Cs.png"];
           // CGRect rect = CGRectMake(16.0f, 1.0f, 289, 529);
           // Q4As.frame = rect;
            Q4As.hidden = NO;
            countQA1 = 0;countQB1 = 0;countQC1 = 0;
...
- (IBAction)Quiz4ValidateResults:(id)sender {
    [self QuestionResultValidation];
}

- (IBAction)showQuiz4infoView:(id)sender
{
    Quiz4infoViewController *Quiz4infoView = [[Quiz4infoViewController alloc] initWithNibName:@"Quiz4infoViewController" bundle:nil];
    Quiz4infoView.modalTransitionStyle = UIModalTransitionStyleCrossDissolve;
    [self presentModalViewController:Quiz4infoView animated:YES];
